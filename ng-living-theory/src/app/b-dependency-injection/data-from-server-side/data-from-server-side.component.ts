...
@Component({
  ...
  template: `
    ...
    <div>
      <p>
        Będziemy pobierać dane z serwera API. W tym celu
        użyjemy <code>provideHttpClient()</code> w konfiguracji aplikacji.
        Dzięki temu będziemy mogli korzystać z serwisu <code>HttpClient</code> umożliwiającego komunikację z serwerem API.
      </p>
      <p>
